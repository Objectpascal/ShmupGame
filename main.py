...
power_up_dir=os.path.join(os.path.dirname(__file__),"power_up");
coin_dir=os.path.join(os.path.dirname(__file__),"coin");
total_frams=0;
pygame.init();
pygame.mixer.init();
...
background=pygame.image.load(os.path.join(img_dir,"sparkle_0.jpg")).convert();
background_rect=background.get_rect();
player_img=pygame.image.load(os.path.join(img_dir,"playerShip1_orange.png")).convert();
player_mini_img=pygame.transform.scale(player_img,(25,19));
player_mini_img.set_colorkey(BLACK);
player_die_sound=pygame.mixer.Sound(os.path.join(sonic_exp_dir,"rumble1.ogg"));
...
player_hide_sound=pygame.mixer.Sound(os.path.join(power_up_dir,"player_exp.wav"));
laser_2_sound=pygame.mixer.Sound(os.path.join(sound_dir,"Laser_Shoot8_2.wav"));
coins_tileSheet=pygame.image.load(os.path.join(coin_dir,"coins.png"))#.convert();
exp_sound=[];
